...
$(document).ready(function(){
  ...
  let msg = ['Frontend developer',"Using ","HTML","CSS","Javascript JS","Tailwind css","and bootstrap"];
...
let co = 0;
let coun = 0
let team = setInterval(()=>{

  let newarray = tech[co];
  // console.log(newarray)

  let slicee = newarray.slice(0,coun++);
  if(coun==newarray.length+1){
    coun=0
